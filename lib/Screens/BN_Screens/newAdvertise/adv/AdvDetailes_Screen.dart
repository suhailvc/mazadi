...
class AdvDetailes_Screen extends StatefulWidget {
  @override
  State<AdvDetailes_Screen> createState() => _AdvDetailes_ScreenState();
}

class _AdvDetailes_ScreenState extends State<AdvDetailes_Screen> {
  ...
  Future getQuestions() async {
    ...
    for (int i = 0;
      ...
      SharedPreferencesController().features.add({
        'key': _Advertisements_getxController
            .category_featuresQ_Model!.data[i].title,
        'value': _Advertisements_getxController
            .category_featuresQ_Model!.data[i].textEditingController.text
      });
    }
            ...
            children: [
              ...
              SizedBox(
                child: GetX<Advertisements_GetxController>(
                  ...
                  return controller.isLoadingQuestions.isTrue ||
                          controller.isLoadingIDData.isTrue
                      ? Center(
                          child: Container(
                            height: 60.h,
                            width: 60.w,
                      ...
                      : Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              if (controller.category_featuresQ_Model != null)
                                SizedBox(
                                                                  ...
                                                                  return RadioListTile(
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        controller
                                                                            ...
                                                                            .data[index]
                                                                            .groupValue = value!;
                                                                        SharedPreferencesController().features[index]['value'] = _Advertisements_getxController
                                                                            .category_featuresQ_Model!
                                                                            .data[index]
                                                                            .textEditingController
                                                                            .text;
                              ...
                              TextFormField(
                                controller: controller
                                    .cities_model!.CityEditingController,
                                textAlignVertical: TextAlignVertical.bottom,
                                minLines: 1,
                                readOnly: true,
                                onTap: () {
