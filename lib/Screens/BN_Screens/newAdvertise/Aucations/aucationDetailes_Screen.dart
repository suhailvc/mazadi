...
class aucationDetailes_Screen extends StatefulWidget {
  @override
  State<aucationDetailes_Screen> createState() =>
      _aucationDetailes_ScreenState();
}

class _aucationDetailes_ScreenState extends State<aucationDetailes_Screen> {
                    ...
                    return controller.isLoadingQuestions.isTrue
                        ...
                        : Column(
                             ...
                             */
                              ...
                              if (controller.isLoadingSingleAucation.isFalse)
                                Row(
                                  children: [
                                    SvgPicture.asset(AppImages.circle),
                                    SizedBox(
                              ...
                              customElevatedButton(
                                onTap: () {
                                  if (_formKey.currentState!.validate()) {
                                    Get.to(saveAucationDetailes_Screen());
                                  }
                                  ;
                                },
                                color: AppColors.main_color,
