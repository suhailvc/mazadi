...
import 'UpdateAdvDetailes_Screen.dart';

class UpdateAdvCategory_Screen extends StatefulWidget {
  late singleAdvertisement_Model? Adv_model;

  @override
  State<UpdateAdvCategory_Screen> createState() =>
      _UpdateAdvCategory_ScreenState();

  UpdateAdvCategory_Screen({required this.Adv_model});
}

class _UpdateAdvCategory_ScreenState
    extends State<UpdateAdvCategory_Screen> {
            ...
            children: [
              ...
              customElevatedButton(
                onTap: () {
                    ...
                    Get.to(UpdateAdvDetailes_Screen(Adv_model: widget.Adv_model,hasChangeCategory: hasChangeCategory,));
                },
                color: AppColors.main_color,
                child: Text(
                  'Continue'.tr,
