...
class singleAucation_Screen2 extends StatefulWidget {
  late singleAucations_Model? aucations_model;

  singleAucation_Screen2({required this.aucations_model});

  @override
  State<singleAucation_Screen2> createState() => _singleAucation_Screen2State();
}

class _singleAucation_Screen2State extends State<singleAucation_Screen2> {
  timeRemain() {
  ...
  void initState() {
    ...
    appTax =
        (double.parse(widget.aucations_model!.data.price!) *
            (double.parse(
                _home_getxController.setting_model!.data.auctionRatio)));
    if (appTax >=
                          ...
                          children: [
                            ...
                            widget.aucations_model!.data!.wishlist==1
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  widget.aucations_model!.data!.wishlist==1 ?
                                  widget.aucations_model!.data!.wishlist=0:
                                  widget.aucations_model!.data!.wishlist=1;
                                  setState(() {});
                                                            ...
                                                            if (myBid >
                                                              ...
                                                              appTax =
                                                                  (double.parse(widget
                                                                          ...
                                                                          .data
                                                                          .price!) *
                                                                      (double.parse(_home_getxController
                                                                          .setting_model!
                                                                          .data
                                                                          .auctionRatio)));
                                                              if (appTax >=
                                                    ...
                                                    Padding(
                                                      padding:
                                                          EdgeInsets.symmetric(
                                                              horizontal: 15),
                                                      child: Text(
                                                        'سيتم خصم مبلغ تأمين يساوي ${double.parse(appTax.toStringAsFixed(1))}' +
                                                            ' ' +
                                                            'Qar'.tr +' عند أول مزايدة تقوم بها',
                                                        style: TextStyle(
                                                            fontFamily: 'Cairo',
                                                            fontSize: 12.sp,
                                                            fontWeight:
                                                  ...
                                                  if (diff.inMinutes > 0) {
                                                    if (checkBoxValue) {
                                                      if (appTax <=
                                                        ...
                                                        if (await Helper()
                                                            .checkInternet()) {
                                                          singleAucations_Model newAuction = await _aucation_getxController
                                                              .add_AucationBid(
                                                              context,
                                                          ...
                                                          if (newAuction.status!) {
                                                            ...
                                                            // _profile_getxController.wallet_model!.data.free=_profile_getxController.wallet_model!.data.free-appTax;
                                                            //
                                                            // _profile_getxController.wallet_model!.data.total = _profile_getxController.wallet_model!.data.total - appTax;
                                                            //
                                                            // _profile_getxController.update();
