...
import 'package:mazzad/Screens/BN_Screens/Aucations/mySingleAucation_Screen2.dart';
...
class mySingleAucation_Screen extends StatefulWidget {
  late singleAucations_Model? aucations_model;

  mySingleAucation_Screen({required this.aucations_model});

  @override
  State<mySingleAucation_Screen> createState() =>
      _mySingleAucation_ScreenState();
}

class _mySingleAucation_ScreenState extends State<mySingleAucation_Screen> {
                          ...
                          GestureDetector(
                            onTap: () {
                              Get.to(() => singleAttachment_Screen(
                                    ...
                                    attachmentType: e ==
                                            widget
                                                .aucations_model!.data.vedio_thumb
                                        ? 'video'
                                        : 'image',
                                  ));
                            },
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            _aucation_getxController.AucationChangeStatusByID(
                                ID: widget.aucations_model!.data.categoryId);

                            Get.to(UpdateAdLanguage_Screen(
                        ...
                        children: [
                          ...
                          StreamBuilder<DocumentSnapshot>(
                              ...
                              builder: (BuildContext context,
                                ...
                                //
                                //   widget.aucations_model!.data!.lastBid = data['lastPrice']??widget.aucations_model!.data!.lastBid;
                                // }
                                if (snapshot!.hasData) {
                                  var data = snapshot.data!;
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    widget.aucations_model!.data.features![index]
                                        .key
                                        .toString(),
                                    style: TextStyle(
                                        fontFamily: 'Cairo',
                              ...
                              if (await Helper().checkInternet()) {
                                ...
                                if (singleAucation != null) {
                                  if (singleAucation.data.user!.id ==
                                    ...
                                    Get.to(mySingleAucation_Screen2(
