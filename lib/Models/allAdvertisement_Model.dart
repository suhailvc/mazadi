...
class allAdvertisement_Model {
 ...
 late int? code;
  ...
  allAdvertisement_Model(
      );

  allAdvertisement_Model.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
 ...
 late List<SubCategories>? subCategories;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    // style = json['style'];
    advertisementsCount = json['advertisements_count'];
...
class SubCategories {
 ...
 late String? icon;
 late int? parentId;
 late List<SubCategories2>? subCategories;
